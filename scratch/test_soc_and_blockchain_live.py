...
def test_live_security_and_blockchain():
    ...
    print("[PASS] [200 OK] Admin authentication successful.")
    ...
    print("[PASS] [200 OK] Admin Security Operations Center (SOC) tab rendered properly.")
    ...
    print("[PASS] [200 OK] Batch minting articles into cryptographic blockchain ledger executed.")
    ...
    print(f"[PASS] [200 OK] Full Blockchain Audit passed! Total Blocks: {audit_data.get('total_blocks')}, Chain Health: {audit_data.get('status')}")
    ...
    if verify_resp.status_code == 200:
        ...
        print(f"[PASS] [200 OK] Public Cryptographic Certificate for Article #1 verified (Block #{v_data['proof']['block_number']}).")
    else:
        print("Article #1 not found, checking HTML certificate.")
    ...
    print(f"[PASS] [200 OK] IP {test_ip} successfully blacklisted in firewall.")
    ...
    print("[PASS] [403 Forbidden] WAF successfully intercepted SQL Injection attack payload!")
    ...
    print("[PASS] [403 Forbidden] WAF successfully intercepted XSS injection attack payload!")
    ...
    print("[PASS] [403 Forbidden] WAF successfully intercepted RCE Command injection payload!")
    ...
    print(f"[PASS] [403 Forbidden] Firewall dropped connection from Blacklisted IP {test_ip}!")
