...
class SiteConfigRepository:
    ...
    def seed_default_configs(self, force: bool = False) -> None:
        defaults = {
            ...
            "news_sources": {
                "hours_between_runs": 3,
                "max_retries": 3,
                "backoff_base_seconds": 2.0,
                "per_source_limit": 5,
                "request_timeout": 15,
                "sources": [
                    {"key": "bbc_world_rss", "name": "BBC World News", "type": "rss",
                     "url": "https://feeds.bbci.co.uk/news/world/rss.xml",
                     "category": "international", "enabled": True,
                     "max_retries": 3, "backoff_base": 2.0, "max_items": 3},
                    {"key": "aljazeera_rss", "name": "Al Jazeera", "type": "rss",
                     "url": "https://www.aljazeera.com/xml/rss/all.xml",
                     "category": "international", "enabled": True,
                     "max_retries": 2, "backoff_base": 2.0, "max_items": 3},
                    {"key": "newsapi_top_headlines", "name": "NewsAPI Top Headlines",
                     "type": "newsapi", "url": "https://newsapi.org/v2/top-headlines",
                     "params": {"country": "us", "pageSize": 10}, "api_key": "",
                     "category": "general", "enabled": False,
                     "max_retries": 3, "backoff_base": 2.0, "max_items": 5},
                    {"key": "guardian_world", "name": "The Guardian API", "type": "guardian",
                     "url": "https://content.guardianapis.com/search",
                     "params": {"section": "world", "page-size": 10}, "api_key": "",
                     "category": "international", "enabled": False,
                     "max_retries": 3, "backoff_base": 2.0, "max_items": 5},
                ],
            },
            "agent_policy": {
            ...
            "fact_check_policy": {
                ...
                "cross_source_min_similarity": 0.55,
                "cross_source_sample": 300,
